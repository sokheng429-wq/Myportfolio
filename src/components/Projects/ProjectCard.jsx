...
function ProjectCard({title , description , imgSrc , navId ,codeLink , codeLinks, demoLink, technologies , className}) {
         ...
         <div className="card off-white mb-8 pt-3" style={{ maxWidth: "100%" }}>
                    ...
                    <div className={`row g-0 ${className}`}>
                        ...
                        <div className="card-body text-center ">
                            ...
                            <a href={demoLink} target="_blank" rel="noreferrer" className="text-decoration-none">
